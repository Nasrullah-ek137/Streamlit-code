...
# Sidebar content
st.sidebar.markdown("---")
st.sidebar.subheader("Subscribe to our Youtube Channel")
st.sidebar.video("https://www.youtube.com/watch?v=P-znzcFaGBU&t=1s")
st.sidebar.markdown("---")
st.sidebar.markdown("Created by: [Mohd Nasrullah Sidddiqui]")
st.sidebar.markdown("Contact: [Email](mailto:siddiquinasrullah9@gmail.com.com)")
